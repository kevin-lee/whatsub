...
:::tip Recommended
Download: [whatsub-cli-windows-latest.exe](https://github.com/Kevin-Lee/whatsub/releases/download/v1.0.1/whatsub-cli-windows-latest.exe)
:::

#### Java Package (JVM)
Download and unzip the `whatsub-cli-1.0.1.zip` just like Linux or macOS.

You can run `whatsub-cli-1.0.1/bin/whatsub.bat` file but it hasn't been tested.
