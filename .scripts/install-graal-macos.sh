...
ls -l $app_package_file || { echo "${app_name_to_display} version ${app_version} doesn't seem to exist." && false ; }
...
echo -e "\n${app_name_to_display} is ready to use. Try"
